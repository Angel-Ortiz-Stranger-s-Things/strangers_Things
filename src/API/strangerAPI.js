//I thank emily a fellow teammate for walking me through this on friday september 8th
...
export async function fetchMyData() {
    try {
        ...
        console.error("Error when trying to fetch your data", error);
    }
}
...
export async function deletePost(POST_ID) {
    try {
        ...
        console.error('Error when trying to deleting post', error);
    }
}
